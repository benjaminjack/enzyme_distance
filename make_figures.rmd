...
## WCN and RSA with respect to the biological assembly, interface residues removed

The following figures were generated using WCN and RSA with respect to the biological assembly and with interface residues removed. Please see the main text and supporting figures for figure captions.
...
NO_INTERFACE <- T   # Remove interface residues
